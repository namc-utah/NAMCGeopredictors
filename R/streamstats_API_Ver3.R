...
#this section will define a shiny function that will help us
#move the points to ensure they are on the streamstats grids and not a tributary
#then, we can run the rest as normal with updated coordinates.
